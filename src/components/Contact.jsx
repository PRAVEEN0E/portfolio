    ...
    <section id="contact" className="py-16 sm:py-20 bg-gray-50 dark:bg-gray-800/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="w-20 h-1 bg-blue-600 mx-auto rounded-full mb-6 sm:mb-8"></div>
          <p className="max-w-2xl mx-auto text-base sm:text-lg text-gray-600 dark:text-gray-300 px-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-start">
          ...
          >
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-1 sm:mb-2">Let's Connect</h3>
            ...
            <div className="flex flex-col gap-3 sm:gap-4">
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 truncate">@PRAVEEN0E</div>
                </div>
              </a>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 truncate">praveeneswaramoorthi</div>
                </div>
              </a>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 truncate">praveeneswaramoorthi08@gmail.com</div>
                </div>
              </a>
            </div>
          </motion.div>
          ...
          >
            <form
              ...
              className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-800 p-5 sm:p-8 flex flex-col gap-4 sm:gap-5"
            >
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm sm:text-base"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none text-sm sm:text-base"
                />
              </div>
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 w-full py-3 sm:py-4 px-6 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-semibold rounded-xl shadow-lg shadow-blue-500/20 transition-all transform hover:-translate-y-0.5 disabled:cursor-not-allowed text-sm sm:text-base"
              >
                {status === 'sending' ? (
                  <>
              ...
              {status === 'success' && (
                <motion.p
                  ...
                  className="text-center text-green-600 dark:text-green-400 font-medium bg-green-50 dark:bg-green-900/20 py-3 rounded-xl text-sm sm:text-base"
                >
              ...
              {status === 'error' && (
                <motion.p
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="text-center text-red-600 dark:text-red-400 font-medium bg-red-50 dark:bg-red-900/20 py-3 rounded-xl text-sm sm:text-base"
                >
